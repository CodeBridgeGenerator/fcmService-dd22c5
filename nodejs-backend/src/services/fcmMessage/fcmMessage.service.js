const { FcmMessage } = require("./fcmMessage.class");
const createModel = require("./fcmMessage.model");
const hooks = require("./fcmMessage.hooks");
...
module.exports = function (app) {
  ...
  app.use("/fcmMessage", new FcmMessage(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("fcmMessage");

  // Get the schema of the collections 
  app.get("/fcmMessageSchema", function (request, response) {
